...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profile_list = __webpack_require__(183);

	var _profile_list2 = _interopRequireDefault(_profile_list);
	...
	var API_URL = 'https://apis.trainheroic.com/public/leaderboard/468425';
	...
	var App = function (_Component) {
		...
		function App() {
			...
			_this.fetchProfiles(API_URL);
			return _this;
		}

		_createClass(App, [{
			key: 'fetchProfiles',
			value: function fetchProfiles(url) {
				var _this2 = this;
			...
			value: function render() {
				...
				return _react2.default.createElement(
					...
					_react2.default.createElement(_profile_list2.default, { profiles: this.state.data.results }),
					_react2.default.createElement(_footer2.default, { footerlines: this.state.data })
				);
			}
		}]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Item = function Item(_ref) {
		...
		var tests = profile.tests.map(function (test) {
			return _react2.default.createElement(
				"label",
				{ key: test },
				test
		...
		return _react2.default.createElement(
			"div",
			{ className: "list-group-item profile-list-item" },
			_react2.default.createElement(
				"p",
				{ className: "profile-list-item_rank" },
				profile.rank
			),
			_react2.default.createElement(
				"div",
				{ className: "profile-image" },
				_react2.default.createElement("img", { className: "portrait", src: profile.profileImg })
			),
			_react2.default.createElement(
				"p",
				null,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _profile_list_item = __webpack_require__(182);

	var _profile_list_item2 = _interopRequireDefault(_profile_list_item);

	var _nukaCarousel = __webpack_require__(186);
	...
	var ProfileList = function ProfileList(_ref) {
		...
		var profileItems = profiles.map(function (profile) {
			return _react2.default.createElement(_profile_list_item2.default, {
				key: profile.userId,
				profile: profile
			});
		});
		...
		return _react2.default.createElement(
			...
			{ className: 'profile-list list-group',
				autoplay: true,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Loading = function Loading() {
		return _react2.default.createElement(
			...
			_react2.default.createElement("img", { className: "logo-img", src: "images/logo.png" })
		);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _kwReactTweenState = __webpack_require__(188);

	var _kwReactTweenState2 = _interopRequireDefault(_kwReactTweenState);

	var _decorators = __webpack_require__(189);
	...
	var _exenv = __webpack_require__(191);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Footer = function Footer(_ref) {
		var footerlines = _ref.footerlines;

		var avg = parseFloat(Number(footerlines.testStats[0].avg).toFixed(2));
		...
		return _react2.default.createElement(
			...
			_react2.default.createElement(
				_nukaCarousel2.default,
				{ className: 'footer-slider', vertical: true, autoplay: true, autoplayInterval: 3500, wrapAround: true },
				_react2.default.createElement(
					'p',
					null,
					'Workout Date: ',
				...
				_react2.default.createElement(
					...
					null,
					'Workout Mode: ',
					footerlines.workoutTitle
				),
				_react2.default.createElement(
					'p',
					null,
					'Instructions: ',
					footerlines.tests[0].testInstructions
				),
				_react2.default.createElement(
					'p',
					null,
					'Number of Players: ',
					footerlines.testStats[0].cnt
				),
				_react2.default.createElement(
					'p',
					null,
